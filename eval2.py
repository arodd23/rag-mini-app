...
from rag_core2 import RAGSystem
...
EVAL_PATH = Path("data/eval_expansion/eval_phase3.jsonl")
...
def load_eval_set(
    ...
    with path.open(
        ...
        for line_number, line in enumerate(
            ...
            if "gold_chunk_ids" in record:
            ...
            elif "gold_chunk_id" in record:
                legacy_id = record["gold_chunk_id"]
                ...
                raise ValueError(
                    f"Bad record on line "
                    f"{line_number}. "
                    f"Missing gold_chunk_ids/gold_chunk_id."
                )
